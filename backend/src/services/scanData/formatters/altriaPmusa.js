/**
 * altriaPmusa.js — Altria PMUSA (Cigarettes) feed formatter (Session 47).
 *
 ...
 * different feed-code header field. See altriaUsstc.js / altriaMiddleton.js.
 */
...
export function formatAltria({ enrollment, transactions, productMapByUpc, periodStart, periodEnd, feedCode = 'PMUSA' }) {
  const lines = [];
  const records = [];
