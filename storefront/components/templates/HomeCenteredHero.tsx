...
export default function HomeCenteredHero({
  content,
  store,
  products = [],
  departments = [],
  ...
  const heroStyle: CSSProperties = heroImg
    ? {
        ['--tpl-hero-bg' as string]: `linear-gradient(rgba(0,0,0,0.45), rgba(0,0,0,0.55)), url(${heroImg})`,
  ...
  return (
    <>
      <section className="tpl-hero tpl-hero--centered" style={heroStyle}>
