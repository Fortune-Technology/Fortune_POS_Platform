...
export default function HomeOverlay({ content, store, products = [], departments = [], storeSlug }: TemplateProps) {
  ...
  const heroStyle: CSSProperties = heroImg
    ? { ['--tpl-hero-bg' as string]: `url(${heroImg})`, backgroundImage: 'var(--tpl-hero-bg)' }
    : {};

  return (
    <>
      <section className="tpl-hero tpl-hero--overlay" style={heroStyle}>
